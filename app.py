...
function openDetail(slug){
  ...
  fetch('/api/character?slug='+encodeURIComponent(slug)).then(function(r){return r.json()}).then(function(ch){
    ...
    html+=img?'<img class="detail-img" src="'+img+'" onerror="this.onerror=null;this.src=\'/api/image?url=\'+encodeURIComponent(this.src)" alt="" onclick="window.open(this.src)">':'';
